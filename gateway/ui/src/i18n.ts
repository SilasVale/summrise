...
const I18N = {
  zh: {
    ...
    "auth.inviteCode": "邀请码",
    "auth.usernamePh": "用户名",
    "auth.adminKeyPh": "管理员密钥",
    "auth.newPasswordPh": "新密码（至少 8 位）",
    "auth.passwordPh": "密码",
    ...
    "nav.routes": "接入设置",
    "nav.models": "模型目录",
    "models.addTitle": "新增模型",
    "models.addDesc":
      "把上游已有的模型加进本网关的目录。选渠道 + 填模型名即可——其余属性从渠道继承，或用下面的开关覆盖。",
    "models.pickChannel": "选择渠道…",
    "models.namePh": "模型名（不含前缀）",
    "models.wirePh": "上游 wire 名（可选，仅 og/ 有效）",
    "models.usEgress": "经美国出口",
    "models.search": "支持联网搜索",
    "models.add": "新增",
    "models.added": "已新增",
    "models.adding": "新增中…",
    "models.addHint": "新增后立刻出现在 /v1/models 与上面的目录里；无需重新部署。",
    "models.delete": "删除",
    "models.disable": "停用",
    "models.deleteConfirm": "删除自建模型 {id}？此操作不可撤销。",
    "models.disableConfirm":
      "停用内置模型 {id}？它将立刻从目录与 /v1/models 消失，指向它的路由也会失效。",
    "models.deleted": "已删除",
    "models.disabled": "已停用",
    "models.enabled": "已启用",
    "models.disabledTitle": "已停用的模型",
    "models.disabledDesc":
      "内置模型不会被删除——它们的六个属性无法由表单重建。停用只停止广告与路由，随时可以恢复。",
    "models.enable": "启用",
    "models.lede":
      "本网关对外广告的全部模型，按渠道分组。点击任一模型即可把本账号的路由切到它——列表由服务端注册表派生，不在这里手写。",
    "models.count": "个模型",
    "models.noPrefix": "无前缀（默认渠道）",
    "models.up": "渠道可用",
    "models.down": "渠道异常",
    "models.notChecked": "未探测",
    "models.switched": "路由已切换",
    "models.isCurrent": "当前路由",
    "models.setCurrent": "切换到这个模型",
    "models.unavailable": "读不到模型目录——这不代表网关没有模型可提供，只代表这次读取失败了。",
    "nav.users": "用户管理",
    "nav.devices": "设备管理",
    ...
    "token.desc":
      "客户端 <code>x-api-key</code> 填这个值；模型名用 <code>og/…</code>、<code>ds/…</code> 前缀路由。",
    ...
    "routes.title": "路由状态",
    "routes.lede":
      "请求模型名按 <code>前缀/模型</code> 路由到对应后端；无前缀默认走 Command Code（模型名原样透传）。",
    "route.title": "当前渠道",
    "route.none": "未选择（走默认渠道）",
    "route.pickInModels": "在模型目录中选择 →",
    "route.desc":
      "Claude Code 模型名配 <code>auto</code> 后，本账号的请求就按下面选中的渠道走。切换在<strong>模型目录</strong>里点选，即时生效、无需重启；这里只显示当前选中的是哪一个。未选择时默认走 <code>cm/deepseek/deepseek-v4.1-flash</code>。",
    "route.use": "使用",
    "route.current": "当前",
    "route.bad": "异常",
    "route.auto": "恢复默认渠道",
    ...
    "usproxy.title": "美国出口",
    "usproxy.desc":
      "所有模型经 Vercel 美国节点访问上游，规避区域限制。注意：og/deepseek-v4.1-flash 的慢在 zen 服务器自身，此开关对它无改善。",
    "usproxy.on": "已开启：请求走美国出口",
    "usproxy.off": "已关闭：请求直连上游",
    "usproxy.turnOn": "开启美国出口",
    "usproxy.turnOff": "关闭美国出口",
    ...
    "key.amd.hint": "developer.amd.com.cn/radeon 申请（rc- 开头的免费 key，每日 $1 额度）",
    "key.r4.backend": "r4.codes",
    "key.r4.hint": "r4.codes 申请（coding agent 网关，Anthropic 与 OpenAI 两种协议都原生支持）",
    "key.emptyValue": "值不能为空",
    "key.revealFail": "复制失败 — 无法读取完整密钥，请重试",
    "key.saved": "已保存",
    "key.saveFail": "保存失败",
    "key.usageAccount": "账户",
    "key.windowWeekly": "周",
    ...
    "client.note":
      "模型名里的 <code>[1m]</code> 是 Claude Code 的 1M 上下文窗口标记，上行前它自己会剥掉，网关按前缀路由不受影响。curl 手测勿发带 <code>[1m]</code> 的字面模型名。",
    ...
    "route.gmi.desc":
      "api.gmi-serving.com — MiniMax Week 免费档（M3/M2.7 免费 14 天），透传用户自己的 GMI key，OpenAI 格式",
    "route.amd.backend": "AMD Radeon Cloud",
    "route.amd.desc":
      "developer.amd.com.cn/radeon — 免费池（用户自己的 rc- key），Anthropic /v1/messages 与 OpenAI chat/completions 双原生透传，含 thinking 与工具调用；按模型有全局并发上限（429），每日 $1 额度",
    ...
    "users.list": "用户列表",
    "users.empty": "还没有其他用户。",
    "users.loadFail": "用户列表加载失败",
    "adminpw.unknown": "—（读取失败，状态未知）",
    "user.enabled": "启用",
    "user.disabled": "禁用",
    ...
    "devices.installNote":
      "本地安装完成即全部功能可用（终端/浏览器/记忆/面板，零云依赖）。公网访问（隧道）或联网登记均为可选，装好后在设备 Settings → Gateway 卡片配置。",
    ...
    "devices.deleteNote": "将解除该设备的访问授权并断开其连接；设备本机安装不受影响。",
    "devices.open": "打开面板",
    "devices.copyMcp": "复制 MCP 配置",
    "devices.mcpCopied": "MCP 配置已复制",
    "devices.empty":
      "还没有设备。点右上角「添加设备」手动登记，或在设备上执行安装命令 + 注册码自动登记。",
    ...
    "devices.statusLastRun": "上次运行",
    "devices.lastRunCrashed": "异常退出",
    ...
    "devices.tunnelDownBody":
      "设备 {name} 的隧道未连通。可先在该设备本机打开 http://127.0.0.1:18080/panel/；远程访问需在设备 Settings → Gateway 卡片开启 Public access（免费 cloudflared 隧道）后重试。",
    "devices.advSummary": "网关 MCP 配置（账户级 · 与单台设备无关）",
    "cf.title": "Cloudflare 隧道凭据",
    "cf.configured": "已配置",
    "cf.notConfigured": "未配置",
    "cf.desc":
      "安装时自动配置隧道的账户级 API token（需 Tunnel:Edit + Zone:DNS:Edit 权限）。存这里后，Windows 安装带注册码即可自动取用，无需浏览器授权。",
    "cf.saved": "已保存",
    "cf.empty": "已清除（安装时将回退到浏览器授权）",
    "devices.online": "在线",
    "devices.notChecked": "未检测",
    "devices.offline": "离线",
    "devices.regKeysTitle": "未使用的注册码",
    "devices.regKeysEmpty": "当前没有未使用的注册码",
    "devices.revokeAllConfirm": "确定要吊销全部 {n} 个未使用的注册码吗？此操作不可撤销。",
    "devices.revokedAll": "已吊销 {n} 个注册码",
    ...
    "models.customTag": "自定义",
    "models.credReady": "凭据已配置",
    "models.credMissing": "凭据缺失",
    "models.channelUp": "通道正常",
    "models.channelDown": "通道不可用",
    "models.providerModels": "{n} 个模型",
    "models.removeProvider": "删除供应商",
    "models.removeProviderConfirm": "删除供应商 {prefix}？它下面的模型会一起从目录里消失。",
    "models.addCustomProvider": "添加自定义供应商",
    "models.addCustomHint": "接一个上游：前缀、地址、协议、密钥。密钥可留空表示沿用现有的。",
    "models.prefix": "前缀",
    "models.label": "显示名",
    "models.baseUrl": "接口地址",
    "models.apiKind": "协议",
    "models.apiKey": "密钥",
    "models.keyKeep": "留空＝保持现有密钥",
    "models.noModels": "这个供应商下面还没有对外广告的模型。",
  ...
  en: {
    ...
    "auth.adminKeyPh": "admin key",
    "auth.newPasswordPh": "New password (≥8 chars)",
    ...
    "auth.foot":
      "After signing up, add your own DeepSeek / OpenCode Go keys and route through this gateway.",
    ...
    "nav.routes": "Access",
    "nav.models": "Models",
    "models.addTitle": "Add a model",
    "models.addDesc":
      "Add a model the upstream already serves to this gateway's catalogue. Pick the channel and name it — the rest is inherited from the channel, or overridden with the switches below.",
    "models.pickChannel": "Pick a channel…",
    "models.namePh": "model name (without the prefix)",
    "models.wirePh": "upstream wire name (optional, og/ only)",
    "models.usEgress": "via the US egress",
    "models.search": "supports web search",
    "models.add": "Add",
    "models.added": "Added",
    "models.adding": "Adding…",
    "models.addHint":
      "It appears in /v1/models and in the catalogue above immediately — no redeploy.",
    "models.delete": "Delete",
    "models.disable": "Disable",
    "models.deleteConfirm": "Delete the custom model {id}? This cannot be undone.",
    "models.disableConfirm":
      "Disable the built-in model {id}? It leaves the catalogue and /v1/models at once, and any route pointing at it stops working.",
    "models.deleted": "Deleted",
    "models.disabled": "Disabled",
    "models.enabled": "Enabled",
    "models.disabledTitle": "Disabled models",
    "models.disabledDesc":
      "Built-in models are not deleted — their six facets cannot be re-derived by a form. Disabling stops advertising and routing, and is reversible.",
    "models.enable": "Enable",
    "models.lede":
      "Every model this gateway advertises, grouped by channel. Click one to point this account's route at it — the list is derived from the server's registry, never hand-written here.",
    "models.count": " models",
    "models.noPrefix": "no prefix (default)",
    "models.up": "channel up",
    "models.down": "channel down",
    "models.notChecked": "not probed",
    "models.switched": "Route switched",
    "models.isCurrent": "Current route",
    "models.setCurrent": "Switch to this model",
    "models.unavailable":
      "Could not read the model catalogue — that does not mean the gateway offers none, only that this read failed.",
    "nav.users": "Users",
    "nav.devices": "Devices",
    ...
    "token.desc":
      "Set this as the client <code>x-api-key</code>; prefix model names with <code>og/…</code>, <code>ds/…</code> for routing.",
    ...
    "routes.lede":
      "Model names are routed by prefix; no prefix defaults to Command Code (the model name passes through as-is).",
    "route.title": "Current channel",
    "route.none": "none selected (default channel)",
    "route.pickInModels": "Choose in Models →",
    "route.desc":
      "With the Claude Code model set to <code>auto</code>, this account's requests follow the channel selected below. Switching happens in <strong>Models</strong> and takes effect at once — no restart; this shows which one is selected. Defaults to <code>cm/deepseek/deepseek-v4.1-flash</code> when unset.",
    "route.use": "Use",
    "route.current": "Current",
    "route.bad": "Down",
    "route.auto": "Restore the default channel",
    ...
    "usproxy.desc":
      "Route all models via the Vercel US node to bypass regional blocks. Note: og/deepseek-v4.1-flash slowness is zen's own servers; this switch does not help it.",
    "usproxy.on": "ON: requests go via the US exit",
    "usproxy.off": "OFF: requests go direct",
    "usproxy.turnOn": "Route via US node",
    "usproxy.turnOff": "Stop routing via US",
    ...
    "key.cmd.backend": "Command Code (GOAT)",
    "key.cmd.hint":
      "from commandcode.ai/settings/keys (GOAT plan and above have API access; the Go plan excludes it)",
    "key.amd.backend": "AMD Radeon Cloud",
    ...
    "key.windowWeekly": "weekly",
    "key.windowMonthly": "monthly",
    "key.balanceLabel": "Balance",
    "key.usageUsed": "Used",
    ...
    "route.amd.backend": "AMD Radeon Cloud",
    "route.amd.desc":
      "developer.amd.com.cn/radeon — free BYOK pool (user's own rc-… key, $1/day cap); native Anthropic AND OpenAI passthrough (thinking + tools); per-model global concurrency cap surfaces as 429",
    ...
    "adminpw.isSet": "•••••• (set)",
    "adminpw.notSet": "— (not set)",
    "adminpw.desc":
      "The console login password. Stored hashed; log in with the new one after changing.",
    ...
    "users.loadFail": "Failed to load the user list",
    "adminpw.unknown": "— (could not read — state unknown)",
    ...
    "devices.editNote":
      "Leave the token empty to only rename / re-host (keeps the current credential); filling it overwrites the device credential.",
    "devices.edit": "Edit",
    ...
    "devices.installNote":
      "Once installed locally, everything works (terminal/browser/memory/panel, zero cloud dependency). Public access (tunnel) or online registration are optional — configure them later in the device's Settings → Gateway card.",
    ...
    "devices.deleteNote":
      "Device-linked access is revoked and live connections closed; the local install on the device is not touched.",
    "devices.open": "Open panel",
    "devices.copyMcp": "Copy MCP config",
    "devices.mcpCopied": "MCP config copied",
    "devices.empty":
      'No devices yet. Click "Add device" (top right) to register one manually, or run the install command + key on the device.',
    "devices.statusAgent": "Agent",
    ...
    "devices.regkeyHint":
      "One-time install keys — they self-expire after 1h and are consumed on successful registration.",
    ...
    "devices.statusLastRun": "Last run",
    "devices.lastRunCrashed": "crashed",
    ...
    "devices.tunnelDownBody":
      "The tunnel for device {name} is not connected. Open http://127.0.0.1:18080/panel/ on the device itself; for remote access enable Public access in the device's Settings → Gateway card (free cloudflared tunnel), then retry.",
    ...
    "devices.notChecked": "not checked",
    "devices.offline": "Offline",
    "devices.regKeysTitle": "Unused registration keys",
    "devices.regKeysEmpty": "No unused registration keys",
    "devices.revokeAllConfirm": "Revoke all {n} unused registration keys? This cannot be undone.",
    "devices.revokedAll": "Revoked {n} registration key(s)",
    ...
    "gwMcp.desc":
      "Claude Code connects to the gateway (browser / terminal tools) with this config, using your current account's token.",
    "gwMcp.copy": "Copy gateway MCP config",
    loading: "Loading…",
    "err.loadRoutes": "Failed to load routes",
    "models.providers": "Providers",
    "models.customTag": "Custom",
    "models.credReady": "Credential configured",
    "models.credMissing": "Credential missing",
    "models.channelUp": "Channel up",
    ...
    "models.apiKind": "Protocol",
    "models.apiKey": "Key",
    "models.keyKeep": "blank keeps the current key",
    "models.noModels": "This provider advertises no models yet.",
