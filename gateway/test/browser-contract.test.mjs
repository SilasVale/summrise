...
// (`agent/deploy/summrise-playwright.zip`, `@playwright/mcp` 0.0.79):
...
const ZIP = new URL("../../agent/deploy/summrise-playwright.zip", import.meta.url).pathname;
 ...
 * `agent/deploy/summrise-playwright.zip` directly — which is a 31 MB BOXED ARTIFACT
