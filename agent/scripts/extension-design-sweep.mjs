...
const ROOT = process.env.VALE_SWEEP_ROOT || 'C:\\\\ProgramData\\\\Vale\\\\pwout\\\\extension';
const REPORT_PATH = process.env.VALE_SWEEP_REPORT || 'C:\\\\ProgramData\\\\Vale\\\\pwout\\\\ext-sweep.json';
...
const EXPECTED_ENTRY_PATH = require("path").join(ROOT, "options", "options.html");
