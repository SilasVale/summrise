 ...
 */
export function bundleSweep({ modules, entry }) {
  ...
  parts.push("  if (!(id in __factories)) return __nativeRequire(id);");
  ...
  parts.push("  const local = (spec) => (spec.startsWith('.') ? __require(__map[id][spec]) : __nativeRequire(spec));");
