...
| [0010](0010-linkify-is-off-by-default.md) | Adopted 2026-09-14 | path linkification is off by default: it rewrites nodes the host reconciles in place |
...
| [0011](0011-two-artifacts-one-obligation.md) | Adopted 2026-09-14 | when one obligation rides on two artifacts, an assertion READS BOTH as data and compares them — documentation on either side is a claim that cannot fail (seven instances, rounds 199–224) |
| [0012](0012-tests-are-surfaces.md) | Adopted 2026-09-14 | tests are surfaces for the "never examined" question; generated/vendored/retired/build-output are excluded with stated reasons printed every run |
