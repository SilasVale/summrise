...
| `summrise` CLI | 12 subcommands, **3,773 lines** | RE-MEASURED 2026-09-25 (round 29) at `main = 14c76409`: `wc -l < agent/summrise-agent-npm/src/summrise.ts` → **3,773** (this cell said 3,651 and named the FILE, not the command — and the 122-line growth is the component-address round, which made `resolveComponent` read `components.<name>.url` from the manifest it already fetched). |
