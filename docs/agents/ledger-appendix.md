# Ledger appendix — the two accumulating sections

These two sections are LOOKUP TABLES, not narrative, and they were 59% of `design-ledger.md`
(302 KB + 91 KB of 665 KB). They are here so the ledger stays a record a reader can actually
read in one sitting; the index at the top of the ledger points at this file, and `ledger-budget-check`
now caps BOTH files so neither can silently re-grow into the other.
