...
| `scripts/test/spacing-scale-check.mjs` | add a spacing declaration with an off-scale literal (a planted `13px`) | exit 1, "off-scale spacing rose from 305 to 306" — and a token use replaced by a literal fails the other half |
