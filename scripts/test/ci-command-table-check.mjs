...
const DECLARED = {
  ...
  "node scripts/test/agents-snippet-check.mjs": "every LABELLED code block in AGENTS.md must parse — round 183 failed on a snippet the "
    + "doc told the reader to run (round 186)",
